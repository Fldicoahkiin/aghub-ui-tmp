export default {
	...
	noProviders: "尚無服務商",
	noProvidersDescription: "新增一個推理服務商以開始使用。",
	selectProvider: "選擇一個服務商檢視詳情",
	deleteProvider: "刪除服務商",
	deleteProviderConfirm: "確定要刪除「{{name}}」嗎？此操作無法復原。",
	editProvider: "編輯服務商",
	providerCreated: "服務商建立成功",
	providerUpdated: "服務商更新成功",
	providerDeleted: "服務商刪除成功",
	createProviderError: "建立服務商失敗",
	updateProviderError: "更新服務商失敗",
	deleteProviderError: "刪除服務商失敗",
	providerNamePlaceholder: "例如：OpenAI 生產環境",
	providerBaseUrlPlaceholder: "https://api.openai.com/v1",
	providerApiKeyPlaceholder: "sk-...",
	goToProviderConfig: "前往服務商設定",
	currentProvider: "目前服務商",
	noProviderAssigned: "未指派服務商",
	providerConfigHint: "此檔案包含服務商設定。請在「服務商」分頁中管理服務商。",
	models: "模型",
	selectAgent: "選擇一個代理",
	selectFile: "選擇檔案檢視",
	configFiles: "設定檔",
	rawJson: "原始",
	formattedView: "格式化",
	providerConfigBanner: "此檔案包含服務商設定。",
	goToInferenceProviders: "在推理服務中管理",
