export default {
	...
	noAgentsDescription: "安裝 AI Coding Agent 以在此管理。",
	...
	restartNow: "立即重新啟動",
	// Inference Providers
	inferenceProviders: "模型服務",
	codingAgents: "程式 Agent",
	providers: "Provider",
	...
	noProviders: "尚無 Provider",
	noProvidersDescription: "新增一個模型服務 Provider 以開始使用。",
	selectProvider: "選擇一個 Provider 檢視詳情",
	deleteProvider: "刪除 Provider",
	deleteProviderConfirm: "確定要刪除「{{name}}」嗎？此操作無法復原。",
	editProvider: "編輯 Provider",
	providerCreated: "Provider 建立成功",
	providerUpdated: "Provider 更新成功",
	providerDeleted: "Provider 刪除成功",
	createProviderError: "建立 Provider 失敗",
	updateProviderError: "更新 Provider 失敗",
	deleteProviderError: "刪除 Provider 失敗",
	providerNamePlaceholder: "例如：OpenRouter",
	providerBaseUrlPlaceholder: "https://api.openai.com/v1",
	providerApiKeyPlaceholder: "sk-...",
	goToProviderConfig: "前往 Provider 設定",
	currentProvider: "目前 Provider",
	noProviderAssigned: "未指派 Provider",
	providerConfigHint: "此檔案包含 Provider 設定，請在模型服務頁面中管理。",
	models: "模型",
	...
	rawJson: "Raw",
	formattedView: "格式化",
	providerConfigBanner: "此檔案包含 Provider 設定。",
	goToInferenceProviders: "在模型服務中管理",
