export default {
	...
	noAgentsDescription: "安装 AI Coding Agent 以在此管理。",
	...
	noProvidersDescription: "添加一个 Inference Provider 以开始使用。",
	...
	providerDeleted: "Provider 删除成功",
	createProviderError: "创建 Provider 失败",
	updateProviderError: "更新 Provider 失败",
	deleteProviderError: "删除 Provider 失败",
	providerNamePlaceholder: "例如：OpenRouter",
	providerBaseUrlPlaceholder: "https://api.openai.com/v1",
	providerApiKeyPlaceholder: "sk-...",
	goToProviderConfig: "前往 Provider 配置",
	currentProvider: "当前 Provider",
	noProviderAssigned: "未分配 Provider",
	providerConfigHint: "此文件包含 Provider 配置，请在 Inference Provider 页面中管理。",
	models: "模型",
	...
	rawJson: "Raw",
	formattedView: "格式化",
	providerConfigBanner: "此文件包含 Provider 配置。",
	goToInferenceProviders: "在 Inference Provider 中管理",

	// Agent Management
	agentManagementDescription:
		"管理哪些 Agent 可用于创建 Skill 和 MCP Server。禁用不使用的 Agent。",
	globalConfig: "全局配置",
	cli: "命令行工具",
	...
	noAgentsAvailableHelp: "请先安装或启用至少一个 Agent。",
