export default {
	...
	noProvidersDescription: "Add an inference provider to get started.",
	selectProvider: "Select a provider to view details",
	deleteProvider: "Delete Provider",
	deleteProviderConfirm: 'Delete "{{name}}"? This can\'t be undone.',
	...
	createProviderError: "Failed to create provider",
	updateProviderError: "Failed to update provider",
	deleteProviderError: "Failed to delete provider",
	providerNamePlaceholder: "e.g., OpenAI Production",
	providerBaseUrlPlaceholder: "https://api.openai.com/v1",
	providerApiKeyPlaceholder: "sk-...",
	goToProviderConfig: "Configure in Providers tab",
	currentProvider: "Current Provider",
	noProviderAssigned: "No provider assigned",
	providerConfigHint: "This file contains provider settings. Manage providers in the Providers tab.",
	models: "Models",
	...
	providerConfigBanner: "This file contains provider settings.",
	goToInferenceProviders: "Manage in Inference Providers",
